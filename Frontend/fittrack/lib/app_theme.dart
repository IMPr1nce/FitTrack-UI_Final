...
ThemeData getTheme(Brightness brightness, Color seedColor) {
  ...
  final scheme = ColorScheme.fromSeed(
    ...
    primary: isDark ? const Color(0xFF9FBCFF) : const Color(0xFF4B74E6),
    onPrimary: Colors.white,
    surface: isDark ? const Color(0xFF18212D) : const Color(0xFFCAD8E8),
    onSurface: isDark ? const Color(0xFFEAF2FF) : const Color(0xFF22324A),
    onSurfaceVariant:
        isDark ? const Color(0xFFB2BED1) : const Color(0xFF61718D),
    primaryContainer:
        isDark ? const Color(0xFF314563) : const Color(0xFFD3E1F8),
    onPrimaryContainer:
        isDark ? const Color(0xFFEAF2FF) : const Color(0xFF1E408F),
  );
